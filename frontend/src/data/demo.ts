...
export const demoStockRows = [
  ...
  // 記憶體模組 / SSD 品牌（implement_plan.md）
  mkRow('2451.TW', '創見', '台股', 'A', 109.5, 'TWD', 4.1, 53.0),
  mkRow('3260.TWO', '威剛', '台股', 'A', 43.4, 'TWD', 7.8, 60.0),
  mkRow('4967.TWO', '十銓', '台股', 'A', 52.0, 'TWD', 6.5, 57.0),
  mkRow('5289.TWO', '宜鼎', '台股', 'A', 197.0, 'TWD', 3.4, 51.0),
  mkRow('8271.TWO', '宇瞻', '台股', 'A', 85.0, 'TWD', 5.2, 54.0),
  mkRow('8088.TWO', '品安', '台股', 'A', 68.5, 'TWD', 2.1, 49.0),
]
